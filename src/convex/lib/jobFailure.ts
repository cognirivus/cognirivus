...
export const JOB_FAILURE_CODE = {
	...
	SOURCE_FANOUT_FAILED: 'SOURCE_FANOUT_FAILED',
	...
	ADMIN_DELETE_COMMUNITY_FAILED: 'ADMIN_DELETE_COMMUNITY_FAILED',
	ADMIN_DELETE_USER_FAILED: 'ADMIN_DELETE_USER_FAILED',
	ADMIN_DELETE_KNOWLEDGE_CELL_FAILED: 'ADMIN_DELETE_KNOWLEDGE_CELL_FAILED',
	ADMIN_DELETE_KNOWLEDGE_NOTE_FAILED: 'ADMIN_DELETE_KNOWLEDGE_NOTE_FAILED',
	ADMIN_DELETE_INFORMATION_SOURCE_FAILED: 'ADMIN_DELETE_INFORMATION_SOURCE_FAILED',
	ADMIN_DELETE_DOMAIN_FAILED: 'ADMIN_DELETE_DOMAIN_FAILED',
	ADMIN_DELETE_ENTITY_FAILED: 'ADMIN_DELETE_ENTITY_FAILED',
	ADMIN_DELETE_GOAL_FAILED: 'ADMIN_DELETE_GOAL_FAILED',
	ADMIN_DELETE_PATH_FAILED: 'ADMIN_DELETE_PATH_FAILED',
	R2_DELETE_FAILED: 'R2_DELETE_FAILED',
	R2_ORPHAN_SWEEPER_FAILED: 'R2_ORPHAN_SWEEPER_FAILED',
	AGGREGATE_PARITY_CHECK_FAILED: 'AGGREGATE_PARITY_CHECK_FAILED',
