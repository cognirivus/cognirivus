...
<div class="min-h-full bg-background/50 p-6">
	<div class="mx-auto flex w-full max-w-6xl flex-col gap-12">
		...
		<header class="text-center">
			...
			<p class="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-muted-foreground">
				Private spaces for your study groups to share intelligence, track collective progress, and
				engage in scoped discussions.
			</p>
		...
		<div class="grid gap-12 lg:grid-cols-3">
			...
			<!-- Sidebar: Actions -->
			<div class="space-y-8 lg:border-l lg:pl-12">
				<div class="space-y-6">
					<div>
